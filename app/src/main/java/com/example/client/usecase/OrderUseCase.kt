...
import com.example.client.models.order.DataOrderResponse
import com.example.client.models.order.OrderDetailResponse
import com.example.client.models.order.OrderRequest
import com.example.client.models.order.OrderResponse
...
class OrderUseCase {
    ...
    fun getOrders(user_id: Int): Observable<BaseResponse<List<OrderResponse>>> {
