...
class RechargeActivity : BaseActivityMVP<IRechargePresent>(), View.OnClickListener, IRechargeView {
    ...
    override fun bindComponent() {
        ...
        tv_section_third.text = formatVND.format(sections[2])
    }

    override fun bindEvent() {
        tv_section_first.setOnClickListener(this)
        tv_section_second.setOnClickListener(this)
        tv_section_third.setOnClickListener(this)
    ...
    override fun onClick(v: View) {
        when (v.id) {
            ...
            R.id.tv_section_third -> selectSection(2)
        }
    }
    ...
    private fun selectSection(index: Int) {
        when (index) {
            0 -> {
                ...
                tv_section_third.setBackgroundResource(R.drawable.border_item)
                tv_section_third.setTextColor(Color.BLACK)
            }
            1 -> {
            ...
            2 -> {
                ...
                tv_section_second.setBackgroundResource(R.drawable.border_item)
                tv_section_second.setTextColor(Color.BLACK)
                tv_section_third.setBackgroundResource(R.drawable.bg_btn)
                tv_section_third.setTextColor(Color.WHITE)
            }
        }
